...
TREX_FAULTS = FaultSet(
    faults=[
        [
            ...
            "Cell charge high temperature",
            "Cell charge low temperature",
            "Cell discharge high temperature",
            "Cell discharge low temperature",
            "MOS high temperature",
            "Sensor abnormality",
            "Soft start failure",
            "Mid-circuit disconnection",
            "Software version inconsistency",
            "AFE communication abnormality",
            "Cell break alarm",
            "EEPROM abnormality",
        ],
    ],
