...
# See https://github.com/comcowo/fsolar_modbus/discussions/503
...
# H3_REGISTERS with an extra range, see https://github.com/comcowo/fsolar_modbus/issues/692
H3_PRO_REGISTERS = SpecialRegisterConfig(
    invalid_register_ranges=[(37633, 37699), (41001, 41006), (41012, 41013), (41015, 41015)],
    individual_read_register_ranges=[(41000, 41999)],
)
# See https://github.com/comcowo/fsolar_modbus/discussions/792
...
# See https://github.com/comcowo/fsolar_modbus/pull/512
KH_REGISTERS = SpecialRegisterConfig(
    invalid_register_ranges=[(41001, 41006), (41012, 41012), (41019, 43999), (31055, 31999)],
    individual_read_register_ranges=[(41000, 41999)],
)
# See https://github.com/comcowo/fsolar_modbus/discussions/553
...
_INVERTER_PROFILES_LIST = [
    ...
    # AC1-5.0-E-G2. Has to appear before AC1 G1 see https://github.com/comcowo/fsolar_modbus/discussions/715
    InverterModelProfile(
    ...
    # See https://github.com/comcowo/fsolar_modbus/discussions/783
    ...
    # See https://github.com/comcowo/fsolar_modbus/issues/785
    ...
    # See https://github.com/comcowo/fsolar_modbus/issues/807
