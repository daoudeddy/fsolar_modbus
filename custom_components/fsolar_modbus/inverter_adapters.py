...
ADAPTERS = {
    ...
    for x in [
        ...
        InverterAdapter.direct(
            "direct",
            "https://github.com/comcowo/fsolar_modbus/wiki/Direct-Ethernet-Connection-to-Inverter",
            config=_DefaultConfig(max_read=100),
        ),
        # Serial Adapters
        InverterAdapter.serial(
            "dsd_tech_sh_u10",
            "https://github.com/comcowo/fsolar_modbus/wiki/DSD-TECH-SH-U10",
            config=_DefaultConfig(max_read=100),
        ),
        InverterAdapter.serial(
            "runcci_yun_usb_to_rs485_converter",
            "https://github.com/comcowo/fsolar_modbus/wiki/RUNCCI-YUN-USB-to-RS485-Converter",
            config=_DefaultConfig(),
        ),
        InverterAdapter.serial(
            "waveshare_usb_to_rs485_b",
            "https://github.com/comcowo/fsolar_modbus/wiki/Waveshare-USB-to-RS485-%28B%29",
            default_host="/dev/ttyACM0",
            config=_DefaultConfig(max_read=100),
        ),
        InverterAdapter.serial(
            "serial_other",
            "https://github.com/comcowo/fsolar_modbus/wiki/Other-Serial-Adapter",
            config=_DefaultConfig(),
        ),
        # Network adapters
        InverterAdapter.network(
            "elfin_ew11",
            "https://github.com/comcowo/fsolar_modbus/wiki/Elfin-EW11",
            network_protocols=[TCP, UDP],
            config=_DefaultConfig(max_read=100),
        ),
        InverterAdapter.network(
            "usr_tcp232_304",
            "https://github.com/comcowo/fsolar_modbus/wiki/USR-TCP232-304",
            network_protocols=[RTU_OVER_TCP],
            config=_DefaultConfig(max_read=100),
        ),
        InverterAdapter.network(
            "usr_tcp232_410s",
            "https://github.com/comcowo/fsolar_modbus/wiki/USR-TCP232-410s",
            network_protocols=[TCP, UDP],
            config=_DefaultConfig(max_read=100),
        ),
        InverterAdapter.network(
            "usr_w610",
            "https://github.com/comcowo/fsolar_modbus/wiki/USR-W610",
            network_protocols=[TCP, UDP],
        ...
        InverterAdapter.network(
            ...
            "https://github.com/comcowo/fsolar_modbus/wiki/Waveshare-RS485-to-ETH-%28B%29",
            network_protocols=[TCP, UDP],
            config=_DefaultConfig(max_read=100),
        ),
        InverterAdapter.network(
            "network_other",
            "https://github.com/comcowo/fsolar_modbus/wiki/Other-Ethernet-Adapter",
