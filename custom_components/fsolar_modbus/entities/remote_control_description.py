    ...
    addresses=[
        ...
        RemoteControlAddressSpec(
            input=ModbusRemoteControlAddressConfig(
                ...
                battery_soc=[11036],
                pwr_limit_bat_up=None,
                # Exists, but see https://github.com/comcowo/fsolar_modbus/discussions/666
        ...
        RemoteControlAddressSpec(
            ...
            # The Kuara H3 doesn't support this, see https://github.com/comcowo/fsolar_modbus/issues/532
            holding=ModbusRemoteControlAddressConfig(
                remote_enable=44000,
                timeout_set=44001,
